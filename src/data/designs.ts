...
export const designs: Design[] = [
  {
    ...
    application: "Large centered front print on heavyweight black tee",
    images: {
    ...
    relatedDesigns: ["24h-hand-off", "circadian-corrupted", "maintenance-window"],
    processStages: [
      {
        label: "Rough concept",
  ...
  },
  {
    ...
    printNotes:
      "Works centered on dark garments. Status type should remain legible when print size is reduced for smaller sizes.",
    rejectedNote:
    ...
    application: "Centered front print",
    images: {
  ...
  },
  {
    ...
    printNotes: "Wide chest print; keep band stroke weight bold enough for fabric.",
  ...
  },
  {
    ...
    printNotes: "Wide centered print; type must stay bold at reduced sizes.",
    ...
    application: "Wide centered front print",
    images: {
  ...
  },
  {
    ...
    printNotes:
      "Large type print. Outline stroke on “47” must remain open on fabric — test underbase on dark garments.",
  ...
  },
  {
    ...
    printNotes: "Centered print; keep dashed hero module visible at reduced scale.",
  ...
  },
  {
    ...
    printNotes: "Wide front print; violet must hold against black fabric.",
  ...
  },
  {
    ...
    printNotes: "High-detail noise side benefits from quality screen or DTG.",
  ...
  },
  {
    ...
    conceptExtra: [
      "Legend matters. Without it, the green cell is decoration. With it, the year becomes a story.",
    ],
    printNotes: "Large print recommended so cell matrix remains readable.",
  ...
  },
  {
    ...
    printNotes: "Circular composition; keep threshold stroke bold on dark fabric.",
  ...
  },
  {
    ...
    printNotes: "Panel must stay large enough for row labels to read.",
  ...
  },
  {
    ...
    printNotes: "Centered front; optional back placement of full grid.",
    ...
    application: "Centered front print; back grid optional",
    images: {
